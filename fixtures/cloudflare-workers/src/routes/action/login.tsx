import { createAction, createForm, FormError } from "solid-start/form";
import server, { redirect } from "solid-start/server";
import { db } from "~/db";
import { createUserSession, getUser, login, register } from "~/db/session";
import { useRouteData, useParams, useNavigate } from "solid-app-router";
...
export default function Login() {
  ...
  const [submissions, action] = createAction(
    server(async (form: FormData) => {
      const loginType = form.get("loginType");
      const username = form.get("username");
      const password = form.get("password");
