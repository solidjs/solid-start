...
- **public/** - the `public` directory contains publically-available assets (images, styles, fonts, etc.) for your application. You can read more about using [static assets](/core-concepts/static-assets).
- **src/** - the `src` directory is where most of your SolidStart application code will live. Its aliased to `~/` for importing in your code.
