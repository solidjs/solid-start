...
What's a modern app without some data to power it. SolidStart aims to make it easy to load data from you data sources. It will help you keep your UI updated with your data.
