...
What's a modern app without some data to power it. SolidStart aims to make it easy to load data from your data sources. It will help you keep your UI always uptote date with your data. 
