...
An API route is expected to return a [`Response`][response] object. Lets look at an example of an API route that returns a list of students in a given house, in a specific year:
