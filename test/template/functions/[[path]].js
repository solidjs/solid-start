var manifest = {
	...
	{
		type: "script",
		href: "/assets/entry-client.7a84c830.js"
	}
],
	"index.html": [
]
...
let _ssrSpread = (props, isSvg, skipChildren) => // @ts-ignore
...
function Head(props) {
  {
    return `<head ${_ssrSpread(props, false, true)}>
        ${resolveSSRNode([props.children, createComponent(Meta, {}), createComponent(Links, {})])}
      </head>
    `;
  }
}
function Body(props) {
  {
    return `<body ${_ssrSpread(props, false, true)}>${resolveSSRNode(props.children) }</body>`;
  }
}
